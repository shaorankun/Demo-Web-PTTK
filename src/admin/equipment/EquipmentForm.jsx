...
export default function EquipmentForm({ equipment, categories, providers, onSave, onCancel }) {
    ...
    // Regex: Allow Letters (English + Vietnamese), Numbers, Spaces. Block special chars.
    const VALID_NAME_REGEX = /^[a-zA-Z0-9\s\u00C0-\u1EF9-]+$/;
    ...
    const handleSubmit = (e) => {
        ...
        // Check Name Format (Regex)
        if (!VALID_NAME_REGEX.test(formData.name)) {
            alert("Invalid Format: Product Name must contain only letters, numbers, and spaces.");
            return;
        }
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-scale-up">
                    ...
                    <div className="md:col-span-2 space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input required name="price" type="number" step="0.01" value={formData.price} onChange={handleChange} className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 outline-none" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="category_id" value={formData.category_id} onChange={handleChange} className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 outline-none">
                            ...
                            <div>
                                ...
                                <select name="provider_id" value={formData.provider_id} onChange={handleChange} className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 outline-none">
                                    <option value="">-- Select --</option>
                                    {providers.map(prov => (
                        ...
                        <div>
                            ...
                            <input name="stock" type="number" value={formData.stock} onChange={handleChange} className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 outline-none" />
                        </div>

                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-1">Description</label>
                            <textarea name="description" rows="3" value={formData.description} onChange={handleChange} className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 outline-none resize-none"></textarea>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full pl-9 p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                ...
                <div className="p-6 border-t bg-gray-50 flex justify-end gap-3 sticky bottom-0 z-10">
                    ...
                    <button onClick={handleSubmit} className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-medium flex items-center gap-2 shadow-lg hover:shadow-blue-500/30">
                        <Save size={18} />
                        Save Product
                    </button>
                </div>
